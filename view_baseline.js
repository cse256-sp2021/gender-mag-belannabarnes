...
<div id="cant_remove_text">
    ...
    Turn off the option for including inheritable permissions (in Advanced), and then try removing <span id="cant_remove_username_3" class = "cant_remove_username"></span>  again.
</div>`)
...
perm_remove_user_button  = $('<button id="perm_remove_user" class="ui-button ui-widget ui-corner-all">Remove Current User</button>')
